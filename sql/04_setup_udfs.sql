...
-- ============================================================================
-- 3. AI_ANALYZE_CUSTOMER_BEHAVIOR_SEGMENT
...
CREATE OR REPLACE FUNCTION CUSTOMER_INTELLIGENCE_DB.PUBLIC.AI_ANALYZE_CUSTOMER_BEHAVIOR_SEGMENT("CUSTOMER_IDS_STRING" VARCHAR, "ANALYSIS_DAYS" NUMBER(38,0) DEFAULT 30)
RETURNS VARIANT
LANGUAGE SQL
AS '
WITH parsed_customer_ids AS (
